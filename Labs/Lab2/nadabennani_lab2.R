...
revenue_matrix <- matrix(c(460.998, 314.4, 290.475, 247.900, 309.306, 165.8), nrow = 3, 
                         dimnames = list(c("Movie_1", "Movie_2", "Movie _3"), 
                                         c("US_revenue", "international_revenue")))
total_revenue <- colSums(revenue_matrix)
print(total_revenue)
...
test_t(og_trilogy,preq_trilogy)
