<<<<<<<< HEAD:Labs/Lab2/Chaymae_bennouri_Lab2.R
###################################
###################################
########                   ########
########   Data Science 2  ########
...
binomial_prob(n = 10, k = 8, p = 0.7)

# compare this to dbinom(8,10,0.7)

dbinom(8,10,0.7)

#the both values are the same
...
#We multiply the p-value by 2 because we are conducting a two-tailed test.
========
###################################
###################################
########                   ########
...
# One last question to ponder before next class: Why did we multiply the p-value by 2?
>>>>>>>> Ridwan_Ibidunni:Labs/Lab2/Lab2- Ridwan Ibidunni.R
