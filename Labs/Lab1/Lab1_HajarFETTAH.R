...
# The probability density for a uniform pdf bounded btw 0 and 1 associated with all values of x is: 1 if  0 <= x <= 1 and 0 if x < 0 or x > 1  ((b = 1, a = 1 f(x)  = 1/(b-a) si  a <=x <=b))
...
# The probability density for a uniform pdf bounded btw 5 and 6 associated with all values of x is: 1 if  5 <= x <= 6 and 0 if x < 5 or x > 6 (b = 6, a = 5 f(x)  = 1/(b-a) si  a <=x <=b)
...
# The probability density for a uniform pdf bounded btw 0 and 0.5 associated with all values of x is: 2 if  0 <= x <= 0.5 and 0 if x < 0 or x > 0.5 (b = 0.5, a = 0 f(x)  = 1/(b-a) si  a <=x <=b)
...
# The probability density for a uniform pdf bounded btw 0 and 2 associated with all values of x is: 0.5   if  0 <= x <= 2 and 0 if x < 0 or x > 2 (b = 2, a = 0 f(x)  = 1/(b-a) si  a <=x <=b)
...
# We can notice that the results of the dunif fucntion corresponds to the the probability density for a uniform pdf which means that dunif is an implementation of the pdf in R. 
