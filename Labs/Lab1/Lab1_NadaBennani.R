...
my.vector = c('this','is','a','vector','example')
my.vector
...
#The purpose of function f2 is to verify if the rest of the division of two numbers equal to 0 in other words y must be a dividor of x
### 3.2
...
hist(two.dice(50),breaks=1:12   )
hist(two.dice(100),breaks=1:12   )
hist(two.dice(1000),breaks=1:12  )
hist(two.dice(10000),breaks=1:12  )
...
#The probability density for a uniform pdf bounded between 0 and 1 is constant, meaning that all values of x between 0 and 1 have the same probability. This is because the uniform distribution assumes that each value in its range has an equal chance of occurring. Therefore, all values of x between 0 and 1 have an equal probability density of 1/(1-0) = 1.
...
# The probability density for a uniform pdf bounded between 5 and 6 associated with all values of x between 5 and 6 is 1/(6-5) = 1.
...
# The probability density for a uniform pdf bounded between 0 and 0.5 is 1/(0.5 - 0) = 2.
...
# The probability density for a uniform pdf bounded between 0 and 2 is 1/2, since the area under the curve must be equal to 1. This means that all values of x between 0 and 2 have an associated probability density of 1/2.
...
# We can conclude that the results of the dunif function  function is used to get the uniform distribution so it is its implementation in R.
