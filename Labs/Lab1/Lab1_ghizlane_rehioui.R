...
# ANSWER: The purpose of the function f2 is check of x is divisible by y.
### 3.2
...
roll_2d_x_times <- function(x) {
  vect <- rep(0, times=x) # initialized to zeros
  for(i in 1:x){
    y <- sample(1:6, 2, replace = TRUE)
    vect[i] <- sum(y)
  }
  return(vect)
}
x = 2 # set x to value 2: roll the two-die twice
roll_2d_x_times(x)
### 4.2
...
hist(roll_2d_x_times(10),breaks=1:12)
hist(roll_2d_x_times(50),breaks=1:12)
hist(roll_2d_x_times(100),breaks=1:12)
hist(roll_2d_x_times(1000),breaks=1:12)
hist(roll_2d_x_times(10000),breaks=1:12)
    # ANSWER: I notice that the bigger the number of times we roll the 2 dice, the closer the distribution gets to a normal distribution.
...
rand_22T_78F <- function(x) {
  val <- runif(x,0,1)
  print(val)
  return(val<=0.22)
}
x <- 1 # the value of x can be changed to any other value to test the function
rand_22T_78F(x)
### 4.4
# Based on today's lecture about pdfs, what is the probability density for a uniform pdf bounded between 0 and 1 associated with all values of x between 0 and 1? Explain why.
    # ANSWER: The probability density for a uniform pdf bounded between a and b is expressed as f(x) = 1/(b - a). Therefore, the probability density for a uniform pdf bounded between 0 and 1 associated with all values of x between 0 and 1 is going to be equal to 1 because : f(x) = 1/(1-0) = 1.
### 4.5
# Similarly, what is the probability density for a uniform pdf bounded between 5 and 6 associated with all values of x between 5 and 6?
    # ANSWER: Similarly to 4.4, the probability density for a uniform pdf bounded between 5 and 6 associated with all values of x between 5 and 6 is going to be equal to 1 because : f(x) = 1/(6-5) = 1.
### 4.6
# What is the probability density for a uniform pdf bounded between 0 and 0.5 associated with all values of x between 0 and 0.5?
    # ANSWER: Similarly to 4.4, the probability density for a uniform pdf bounded between 0 and 0.5 associated with all values of x between 0 and 0.5 is going to be equal to 1 because : f(x) = 1/(0.5-0) = 2.
### 4.7
# What is the probability density for a uniform pdf bounded between 0 and 2 associated with all values of x between 0 and 2?
    # ANSWER: Similarly to 4.4, the probability density for a uniform pdf bounded between 0 and 2 associated with all values of x between 0 and 2 is going to be equal to 1 because : f(x) = 1/(2-0) = 0.5.
### 4.8
...
# ANSWER: The dunif function is a Continuous uniform density (Probability density function)
